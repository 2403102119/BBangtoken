...
public class AmendActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        updateDialog = new ActionDialog(AmendActivity.this,"密碼修改成功，請返回重新登錄","确定",false);
        updateDialog.setOnActionClickListener(new ActionDialog.OnActionClickListener() {
            ...
            public void onRightClick() {
                ...
                Intent intent = new Intent(AmendActivity.this,LoginActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.bt_ok:
                ...
                change_password(App.phone,ce_cod,"1",ce_new_pass,ce_affi);
                break;
            case R.id.bt_code:
                ...
                public void run() {
                    httpInterface.amend(account,send_ip, new MApiResultCallback() {
                        ...
                        public void onSuccess(String result) {
                            ...
                            //验证码倒计时
                            MyCountDownTimer timer = new MyCountDownTimer(AmendActivity.this,
                                    bt_code,1*60*1000,1000);
                            timer.start();
                        }
